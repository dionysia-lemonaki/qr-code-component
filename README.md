...
- [Solution URL](https://www.frontendmentor.io/solutions/qr-code-component-d03q2aW3jh)
...
In the HTML, I focused on writing properly formatted and indented code, using Prettier via both a local installation and the Visual Studio Code extension.

I also made sure the code is semantic and accessible by using landmarks (such as `main`), meaningful HTML elements that accurately describe the content and alt text that properly describes the image and its purpose.
